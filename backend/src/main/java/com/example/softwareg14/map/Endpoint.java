...
public class Endpoint {
    ...
    public static final String USER_UPDATE = apiPath + "user/{id}";
    public static final String USER_DELETE = apiPath + "user/{id}";
    ...
    public static final String ORGANIZATION_DELETE = apiPath + "organization/{id}";
    public static final String ORGANIZATION_UPDATE = apiPath + "organization/{id}";
    public static final String TOURS_ALL = apiPath + "tour/all";
    public static final String CREATE_TOUR = apiPath + "tour";
    public static final String TOUR_UPDATE = apiPath + "tour/{id}";
